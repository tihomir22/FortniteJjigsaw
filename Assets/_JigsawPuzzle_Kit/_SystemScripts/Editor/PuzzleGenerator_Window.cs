...
public class PuzzleGenerator_Window : EditorWindow 
{
	...
	static int maxAtlasSize = 4096;		// Max Atlas size
	...
	static Vector2 windowSize = new Vector2(450, 350);
		...
		GUILayout.BeginVertical("box");
			GUILayout.BeginHorizontal();
				GUILayout.BeginVertical();
					...
					maxAtlasSize = Mathf.Clamp (maxAtlasSize, 256, 4096);
				GUILayout.EndVertical();
	...
	void ConvertToSprites () 
	{
		...
		for (int i = 0; i < sprites.Length; i++) 
		{
			...
			EditorUtility.DisplayProgressBar("Step 3/4  (This may take awhile)", "Convert textures to Sprites...", i/(sprites.Length-1.1f));
		}
    ...
    void CreateAtlas()
    {
        ...
        for (int i = 0; i < textureArray.Length; i++)
        {
            ...
            EditorUtility.DisplayProgressBar("Step 2/4", "Save textures to atlas...", i / (textureArray.Length - 1.1f));
        }
